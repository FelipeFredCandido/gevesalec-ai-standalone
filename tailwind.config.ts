...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Colores corporativos GEVESALEC
        primary: {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
      ...
      backgroundImage: {
        ...
        'gradient-ai': 'linear-gradient(135deg, #1e40af 0%, #8b5cf6 50%, #10b981 100%)',
        'gradient-ai-light': 'linear-gradient(135deg, #dbeafe 0%, #ede9fe 50%, #d1fae5 100%)',
      },
      backdropBlur: {
        'xs': '2px',
      },
      boxShadow: {
        ...
        'ai-lg': '0 0 40px rgba(59, 130, 246, 0.4)',
